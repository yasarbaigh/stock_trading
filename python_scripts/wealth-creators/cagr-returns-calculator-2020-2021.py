...
stock_price_query = "SELECT trade_date, isin_code, sc_name, close_price FROM stock_prices_2020_2021  ORDER BY trade_date"
output_dict = {}
invest_amount = 50000
...
write_ouput(csv_rows, "2020-2021-lumpsump-returns-11.csv")
